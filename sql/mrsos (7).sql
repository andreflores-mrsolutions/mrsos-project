...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2025 a las 22:30:29
...
(1, 1, 1, 1001, 2, 1, 'Muestra para pruebas MR1', 'Abierto', 'logs', 'Servicio', '--', '3', '2025-08-08', '2025-05-15 18:42:00', NULL, NULL, NULL, NULL, 'Prueba 2 de asignación de un análisis', NULL, 'confirmada', NULL, '2025-05-15 18:42:00', 'Jonh Due', '555-55-55-55', 'example@correo.com', 1001, 'Activo'),
...
(7, 2, 5, 2001, 3, 3, 'Prueba de ticket Puebla', 'Abierto', 'revision inicial', 'Servicio', '--', '3', '2025-08-08', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, 'Nuevo analisis 6 y final?', NULL, 'confirmada', NULL, NULL, 'Nailea FO', '5534846421', 'nailea@enel.com.mx', 1007, 'Activo'),
...
(9, 2, 6, 2001, 47, 5, 'Prueba de ticket Miyana', 'Abierto', 'revision especial', 'Extra', '--', '1', '2025-08-12', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, 'Analisis A prueba 1', 'ingeniero', 'en espera confirmacion cliente', NULL, NULL, 'Nailea O', '5534846421', 'andre.flores@mrsolutions.com.mx', 1001, 'Activo');
...
(1004, 'Manfredo Augusto', 'Gonzalez', 'Lozada', 'MRA', 'mgonzalez@mrsolutions.com.mx', '$2y$10$BM/012LgYwxjjR1GYbCAbuza69X7FaBU9sgexYU17JPjb.k5gvRha', 0, '2025-10-23 20:56:08', 55, 'N/A', 1, 'NA', 1, 'Si', 'Activo', 'ManfredoG'),
(1005, 'Jorge Antonio', 'Hernandez', 'García', 'MRA', 'jorge.hernandez@mrsolutions.com.mx', '$2y$10$BM/012LgYwxjjR1GYbCAbuza69X7FaBU9sgexYU17JPjb.k5gvRha', 0, '2025-10-23 20:56:08', 55, 'N/A', 1, 'a', 1, 'Si', 'Activo', 'JorgeH'),
(1006, 'Luis', 'Tostado', 'De los Santos', 'MRSA', 'luis.tostado@mrsolutions.com.mx', '$2y$10$BM/012LgYwxjjR1GYbCAbuza69X7FaBU9sgexYU17JPjb.k5gvRha', 0, '2025-10-23 20:56:08', 55, 'N/A', 1, 'a', 1, 'Si', 'Activo', 'LuisT'),
(1007, 'Christian', 'Mata', 'San Luis', 'MRA', 'chmata@mrsolutions.com.mx', '$2y$10$BM/012LgYwxjjR1GYbCAbuza69X7FaBU9sgexYU17JPjb.k5gvRha', 0, '2025-10-23 20:56:08', 55, 'N/A', 1, 'a', 1, 'Si', 'Activo', 'ChistianM'),
(1008, 'Juan Carlos', 'Zafra', 'Daniel', 'MRA', 'juan@mrsolutions.com.mx', '$2y$10$BM/012LgYwxjjR1GYbCAbuza69X7FaBU9sgexYU17JPjb.k5gvRha', 0, '2025-10-23 20:56:08', 55, 'N/A', 1, 'a', 1, 'Si', 'Activo', 'JuanZ'),
(1009, 'Norma', 'De la Cruz', '-', 'MRSA', 'norma@mrsolutions.com.mx', '$2y$10$BM/012LgYwxjjR1GYbCAbuza69X7FaBU9sgexYU17JPjb.k5gvRha', 0, '2025-10-23 20:56:08', 55, 'N/A', 1, 'a', 1, 'Si', 'Activo', 'NormaC'),
...
--
ALTER TABLE `ticket_archivos`
  MODIFY `taId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
