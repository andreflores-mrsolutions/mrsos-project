...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-08-2025 a las 07:20:14
...
INSERT INTO `ticket_soporte` (`tiId`, `clId`, `csId`, `usId`, `eqId`, `peId`, `tiDescripcion`, `tiEstatus`, `tiProceso`, `tiTipoTicket`, `tiExtra`, `tiNivelCriticidad`, `tiFechaCreacion`, `tiVisita`, `tiMeetActivo`, `tiMeetLink`, `tiMeetPlataforma`, `tiDiagnostico`, `tiCitaTipo`, `tiCitaEstado`, `tiCitaPropuesta`, `tiCitaConfirmada`, `tiNombreContacto`, `tiNumeroContacto`, `tiCorreoContacto`, `usIdIng`, `estatus`) VALUES
(1, 1, 1, 1001, 2, 1, 'Muestra para pruebas MR1', 'Abierto', 'finalizado', 'Servicio', '--', '3', '2025-08-08', '2025-05-15 18:42:00', NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, '2025-05-15 18:42:00', 'Jonh Due', '555-55-55-55', 'example@correo.com', 1001, 'Activo'),
(5, 1, 1, 1001, 47, 2, 'Muestra para pruebas MR2', 'Abierto', 'meet', 'Preventivo', '--', '1', '2025-08-02', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, NULL, 'Andre Flores', '5534846421', 'andre.flores@mrsolutions.com.mx', 1002, 'Activo'),
(6, 1, 1, 1001, 47, 2, 'Muestra para pruebas MR3', 'Abierto', 'fecha asignada', 'Extra', '--', '2', '2025-08-02', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, NULL, 'Andre Flores', '5534846421', 'andre.flores@mrsolutions.com.mx', 1002, 'Activo'),
(7, 2, 5, 2001, 3, 3, 'Prueba de ticket Puebla', 'Abierto', 'meet', 'Servicio', '--', '3', '2025-08-08', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, NULL, 'Nailea FO', '5534846421', 'nailea@enel.com.mx', 1002, 'Activo'),
(8, 2, 4, 2001, 44, 4, 'Prueba de ticket Monterrey', 'Abierto', 'encuesta satisfaccion', 'Servicio', '--', '2', '2025-08-12', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, NULL, 'Andre', '7847474', 'prueba@prueba.com', 1002, 'Activo'),
(9, 2, 6, 2001, 47, 5, 'Prueba de ticket Miyana', 'Abierto', 'revision especial', 'Servicio', '--', '1', '2025-08-12', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, NULL, 'Nailea O', '5534846421', 'andre.flores@mrsolutions.com.mx', 1002, 'Activo');
...
(2001, 'Nailea', 'Fragoso', 'Osorio', 'Cliente', 'nailea@enel.com.mx', '$2y$10$BM/012LgYwxjjR1GYbCAbuza69X7FaBU9sgexYU17JPjb.k5gvRha', 0, '2025-05-23 18:56:23', 55, 'N/A', 1, 'a', 2, 'Si', 'Activo', 'NaileaFO');
...
--
ALTER TABLE `sede_usuario`
  MODIFY `suId` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `usuarios`
  MODIFY `usId` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2002;
