...
<nav id="sidebar" class="col-12 col-md-3 col-lg-2 d-none d-lg-block p-3 mr-side">
    ...
    <ul class="nav nav-pills flex-column gap-1">
        ...
        <div class="section-subtitle ">Tickets</div>
        <ul class="nav nav-pills flex-column gap-1">
            <li class="nav-item"><a class="nav-link <?= isActive('poliza', $activeMenu) ?>" href="polizas_index.php?clId=<?= (int)$clId ?>"><i class="bi bi-file-binary"></i> Poliza</a></li>
