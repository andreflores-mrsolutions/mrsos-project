...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-02-2026 a las 06:10:20
...
--
-- Estructura de tabla para la tabla `polizavendedor`
--

CREATE TABLE `polizavendedor` (
  `pvId` int(8) NOT NULL,
  `pcId` int(8) NOT NULL,
  `usId` int(8) NOT NULL,
  `pvEstatus` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(11, 24, 'log', 'log_17_692f1983049bd5.82020539.txt', 'log_24_698ee0489742c8.59874211.txt', 'text/plain', 434, 'uploads/logs/24/log_24_698ee0489742c8.59874211.txt', 2001, '2026-02-13 08:26:48'),
(12, 17, 'log', 'iDRACStateInfo.txt', 'log_17_698ee4546361b7.07690327.txt', 'text/plain', 292540, 'uploads/logs/17/log_17_698ee4546361b7.07690327.txt', 2001, '2026-02-13 08:44:04');
...
CREATE TABLE `ticket_meet_propuestas` (
  ...
  `mpMotivo` varchar(180) DEFAULT NULL,
  ...
  `mpCreadoPor` int(11) DEFAULT NULL,
  `mpCreadoEn` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `ticket_meet_propuestas`
--

INSERT INTO `ticket_meet_propuestas` (`mpId`, `tiId`, `mpBatchId`, `mpAutorTipo`, `mpModo`, `mpPlataforma`, `mpLink`, `mpMotivo`, `mpInicio`, `mpFin`, `mpEstado`, `mpCreadoPor`, `mpCreadoEn`) VALUES
(4, 7, '', 'ingeniero', 'propuesta', NULL, NULL, NULL, '2026-02-11 00:45:00', '2026-02-11 01:15:00', 'aceptada', NULL, '2026-02-11 06:46:04'),
(5, 7, '', 'ingeniero', 'propuesta', NULL, NULL, NULL, '2026-02-11 00:45:00', '2026-02-11 01:15:00', 'rechazada', NULL, '2026-02-11 06:46:04'),
(6, 7, '', 'ingeniero', 'propuesta', NULL, NULL, NULL, '2026-02-11 00:45:00', '2026-02-11 01:15:00', 'rechazada', NULL, '2026-02-11 06:46:04'),
(7, 23, '', 'ingeniero', 'propuesta', 'Zoom', NULL, NULL, '2026-02-11 18:49:00', '2026-02-11 19:19:00', 'rechazada', NULL, '2026-02-12 00:49:56'),
(8, 23, '', 'ingeniero', 'propuesta', 'Zoom', NULL, NULL, '2026-02-11 06:49:00', '2026-02-11 07:19:00', 'aceptada', NULL, '2026-02-12 00:49:56'),
(9, 23, '', 'ingeniero', 'propuesta', 'Zoom', NULL, NULL, '2026-02-11 06:49:00', '2026-02-11 07:19:00', 'rechazada', NULL, '2026-02-12 00:49:56');
...
(1, 1, 1, 1001, 2, 1, 'El equipo presenta un problema en disco duro \ny se necesita cambiar', 'Abierto', 'asignacion', 'Servicio', '--', '3', '2025-08-08', '2025-05-15 18:42:00', NULL, NULL, NULL, 'Prueba 2 de asignación de un análisis', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 127, 'Jonh Due', '555-55-55-55', 'example@correo.com', 1001, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 1, 1, 1001, 47, 2, 'Muestra para pruebas MR2', 'Abierto', 'meet', 'Preventivo', '--', '1', '2025-08-02', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Andre Flores', '5534846421', 'andre.flores@mrsolutions.com.mx', 1002, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 1, 1, 1001, 47, 2, 'Muestra para pruebas MR3', 'Abierto', 'fecha asignada', 'Extra', '--', '2', '2025-08-02', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Andre Flores', '5534846421', 'andre.flores@mrsolutions.com.mx', 1002, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 2, 5, 2001, 3, 3, 'Prueba de ticket Puebla', 'Abierto', 'espera refaccion', 'Servicio', '--', '3', '2025-08-08', '0000-00-00 00:00:00', NULL, NULL, 'meet ingeniero', '{\"logs_request\":{\"motivo\":\"Logs incorrectos (no corresponde al equipo \\/ SN) · Solicito logs correctos.\\nChecklist:\\\\n- Síntoma:\\\\n- Evidencia:\\\\n- Hipótesis:\\\\n- Impacto:\\\\n- Siguiente paso:\",\"by\":1001,\"at\":\"2026-02-11T19:38:52-06:00\"},\"diagnostico\":{\"texto\":\"Logs incorrectos (no corresponde al equipo \\/ SN) · Solicito logs correctos.\\nChecklist:\\\\n- Síntoma:\\\\n- Evidencia:\\\\n- Hipótesis:\\\\n- Impacto:\\\\n- Siguiente paso:\",\"by\":1001,\"at\":\"2026-02-11T19:43:17-06:00\"}}', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Nailea FO', '5534846421', 'nailea@enel.com.mx', 1007, 'Activo', '2026-02-11', '00:45:00', NULL, NULL, 'asignado_ingeniero', 'confirmado', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9, 2, 6, 2001, 47, 5, 'Prueba de ticket Miyana', 'Abierto', 'visita', 'Extra', '--', '1', '2025-08-12', '2025-12-04 19:28:00', 60, 2001, NULL, 'Hola esta es una revisión', 'ingeniero', NULL, NULL, 'Nailea', 0, '', NULL, NULL, '2025-12-04', '09:30:00', 'confirmada', 'asas', 'folio_9_20251201015142.png', '2025-12-01 01:51:42', 2001, 'cliente', '', '2025-12-01 11:46:43', NULL, 1, 'Nailea O', '5534846421', 'andre.flores@mrsolutions.com.mx', 1005, 'Activo', '2025-12-25', '18:12:00', 'Google Meet', 'https://meet.google.com/gtu-ztqu-odf', 'propuesta_cliente', 'pendiente', NULL, NULL, NULL, 'Nailea', NULL, NULL, NULL),
(10, 2, 6, 2001, 47, 5, 'Prueba de ticket Miyana', 'Pospuesto', 'meet', 'Extra', '--', '1', '2025-08-12', '0000-00-00 00:00:00', NULL, NULL, 'meet ingeniero', 'Hola esta es una revisión', 'cliente', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 'confirmada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 127, 'Nailea O', '5534846421', 'andre.flores@mrsolutions.com.mx', 1005, 'Activo', '2026-01-16', '03:40:00', 'Google Meet', '', 'propuesta_ingeniero', 'pendiente', 'cliente', '', '2026-01-03 03:37:50', 'Andre Gonzalo', NULL, NULL, NULL),
(11, 2, 4, 2001, 3, 3, 'a', 'Abierto', 'logs', 'Servicio', '--', '3', '2025-11-30', '0000-00-00 00:00:00', NULL, NULL, NULL, '• Síntomas reportados:\r\n• Evidencia disponible:\r\n• Hipótesis inicial:\r\n• Información faltante:\r\n• Siguiente paso recomendado:', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Andre Flores', '5534846421', 'andre.flores@mrsolutions.com.mx', 1005, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(14, 2, 6, 2001, 44, 4, 'Ninguno es prueba A', 'Abierto', 'logs', 'Servicio', '--', '3', '2025-12-01', '0000-00-00 00:00:00', NULL, NULL, NULL, '• Síntomas reportados:\r\n• Evidencia disponible:\r\n• Hipótesis inicial:\r\n• Información faltante:\r\n• Siguiente paso recomendado:', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Andre Flores', '5534846421', 'andre.flores@mrsolutions.com.mx', 1004, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15, 2, 6, 2001, 44, 4, 'Prueba con correo', 'Abierto', 'logs', 'Servicio', '--', '3', '2025-12-01', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Andre Flores', '5534846421', 'andre.flores@mrsolutions.com.mx', 1002, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(16, 2, 4, 2001, 3, 3, 'aasasasas', 'Abierto', 'encuesta satisfaccion', 'Servicio', '--', '1', '2025-12-02', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Andre Flores', '5534846422', 'andre.flores@mrsolutions.com.mx', 1002, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(17, 2, 6, 2001, 44, 4, 'sas', 'Abierto', 'revision especial', 'Servicio', '--', '2', '2025-12-02', '0000-00-00 00:00:00', NULL, NULL, NULL, '{\"logs_request\":{\"motivo\":\"Checklist:\\\\n- Síntoma:\\\\n- Evidencia:\\\\n- Hipótesis:\\\\n- Impacto:\\\\n- Siguiente paso:\",\"by\":1001,\"at\":\"2026-02-11T19:28:11-06:00\"}}', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Andre Flores', '5534846421', 'andre.flores@mrsolutions.com.mx', 1004, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(18, 2, 6, 2001, 44, 4, 'Problema prueba presental', 'Abierto', 'logs', 'Servicio', '--', '3', '2025-12-02', '0000-00-00 00:00:00', NULL, NULL, NULL, '• Síntomas reportados:\r\n• Evidencia disponible:\r\n• Hipótesis inicial:\r\n• Información faltante:\r\n• Siguiente paso recomendado:', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Andre Flores', '5534846421', 'andre.flores@mrsolutions.com.mx', 1001, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(19, 2, 4, 2001, 3, 3, 'a', 'Abierto', 'logs', 'Servicio', '--', '3', '2026-01-04', '0000-00-00 00:00:00', NULL, NULL, NULL, '• Síntomas reportados:\r\n• Evidencia disponible:\r\n• Hipótesis inicial:\r\n• Información faltante:\r\n• Siguiente paso recomendado:', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Andre Flores', '5534846421', 'andregonzalo47@gmail.com', 1008, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(20, 1, 1, 1001, 2, 1, 'hola', 'Abierto', 'asignacion', 'Servicio', '--', '3', '2026-01-06', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Andre Gonzalo Flores Cabrera', '5534846421', 'andre.flores@mrsolutions.com.mx', 1002, 'Activo', NULL, NULL, NULL, NULL, NULL, 'pendiente', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(23, 2, 5, 2001, 47, 5, 'Health Check (mantenimiento preventivo) programado', 'Abierto', 'meet', 'Preventivo', '--', '3', '2026-01-06', '2026-01-30 00:00:00', 240, NULL, 'meet ingeniero', '{\"diagnostico\":{\"texto\":\"Falla de disco duro\\nFalla de disco duro\\nFalla de disco duro\\nFalla de disco duro\",\"by\":1001,\"at\":\"2026-02-11T20:18:17-06:00\"}}', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Nailea Fragoso Osorio', '5534846421', 'andre.flores@mrsolutions.com.mx', 1002, 'Activo', '2026-02-11', '06:49:00', 'Zoom', NULL, 'asignado_ingeniero', 'confirmado', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(24, 2, 6, 2001, 44, 6, 'Prueba de ticket', 'Abierto', 'asignacion', 'Servicio', '--', '1', '2026-01-20', '0000-00-00 00:00:00', NULL, NULL, NULL, '{\"diagnostico\":{\"texto\":\"Se requiere realizar nuevamente una asignación de ingeniero\",\"by\":1001,\"at\":\"2026-02-13T14:25:10-06:00\"},\"logs_request\":{\"motivo\":\"Logs antiguos (fecha fuera de ventana) · Solicito recaptura.\",\"by\":1001,\"at\":\"2026-02-13T14:16:53-06:00\"}}', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Nailea Fragoso Osorio', '5534846421', 'andre.flores@mrsolutions.com.mx', 1002, 'Activo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Estructura de tabla para la tabla `user_push_devices`
--
...
--
-- Volcado de datos para la tabla `user_push_devices`
--

INSERT INTO `user_push_devices` (`id`, `usId`, `platform`, `token`, `deviceId`, `lastUsedAt`, `createdAt`) VALUES
(1, 2001, 'android', 'eW-ZfHtlRZyz96YTOAIXZG:APA91bFo3RvmhmWZbE1HMGOUjNgZOBwhuhy1v0DhOkEGi1sx9837Jx_ZUNiRuMYgNi1mmOjq7eb-Jbu6ywkELF2x8kaK1O5zwob_O9eMxFkWqc4ePyminMY', '99822bcc90264c13f9e84e96969ce08d', '2026-02-11 07:55:39', '2026-02-11 05:42:35');
...
(4, 2003, 2, 1, 6, 'ADMIN_SEDE', 'Activo'),
(8, 2008, 2, 2, 5, 'USUARIO', 'Activo');
...
--
-- Indices de la tabla `polizavendedor`
--
ALTER TABLE `polizavendedor`
...
ALTER TABLE `ticket_meet_propuestas`
  ...
  ADD KEY `idx_meet_batch_estado` (`tiId`,`mpBatchId`,`mpEstado`),
  ADD KEY `idx_meet_batch` (`tiId`,`mpBatchId`,`mpEstado`);
...
--
-- Indices de la tabla `user_push_devices`
--
ALTER TABLE `user_push_devices`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_device` (`deviceId`),
...
--
-- AUTO_INCREMENT de la tabla `polizavendedor`
--
ALTER TABLE `polizavendedor`
  MODIFY `pvId` int(8) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ticket_meet_propuestas`
  MODIFY `mpId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `ticket_soporte`
--
ALTER TABLE `ticket_soporte`
  MODIFY `tiId` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
-- AUTO_INCREMENT de la tabla `user_push_devices`
--
ALTER TABLE `user_push_devices`
...
--
-- Filtros para la tabla `user_push_devices`
--
ALTER TABLE `user_push_devices`
  ADD CONSTRAINT `fk_push_user` FOREIGN KEY (`usId`) REFERENCES `usuarios` (`usId`) ON DELETE CASCADE;
COMMIT;
