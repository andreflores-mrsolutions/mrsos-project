...
<head>
    ...
    <style>
        ...
        /* Que ninguna card se salga del ancho */
        .equipo-card {
                ...
                <div class="container-fluid">
                    <div class="row">
                        <main class="col-md-9 ms-sm-auto col-lg-12 px-md-4">
                            <div class="main mb-4">
                                <h5>Selecciona un equipo para crear un nuevo ticket</h5>
                                <div class="">
                                    <!-- PASO 1: Equipos -->
                                    ...
                                    <div id="paso3" class="wizard-step" style="display:none;">
                                        ...
                                        <form id="formTicket">
                                            <!-- Este es el que realmente necesita PHP -->
                                            <input type="hidden" name="peId" id="selectedPeId">

                                            <!-- Puedes dejar eqId si luego lo quieres usar para otra cosa, pero no es obligatorio para crear_ticket.php -->
