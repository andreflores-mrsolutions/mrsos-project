...
<style>
  ...
  body.dark-mode .cliente-chip {
    background-color: #020617;
    color: #e5e7eb;
    border-color: #334155;
  }

  body.dark-mode .cliente-chip.active {
    background-color: #1d4ed8;
    color: #fff;
  }
  ...
  body.dark-mode .ticket-zona-title {
    color: #9ca3af;
  }
</style>
<!DOCTYPE html>
...
<head>
  ...
  <script src="../js/admin_tickets.js"></script>
  ...
  <div class="container-fluid">
    <div class="row gx-0">
      ...
      <main class="col-md-12 ms-sm-auto col-lg-10 px-lg-4">
        ...
        <!-- CONTENIDO PRINCIPAL ADMIN TICKETS -->
        <div class="row g-3 mb-4">
          <!-- Columna: selección de clientes -->
          <div class="col-12">
            <div class="card border-0 shadow-sm">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-2 flex-wrap gap-2">
                  <div>
                    <div class="text-uppercase small text-muted">Administración de tickets</div>
                    <h5 class="mb-0">Selecciona un cliente</h5>
                    <div class="small text-muted">
                      Haz clic en un cliente para ver sus tickets agrupados por zona y sede.
                    </div>
                  </div>
                </div>

                <!-- Chips de clientes -->
                <div id="listaClientesTickets" class="mt-3">
                  <!-- Se rellena dinámicamente por admin_tickets.js -->
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- Bloque de tickets del cliente seleccionado -->
        <div class="row g-3">
          <div class="col-12">
            <div id="bloqueTickets" class="d-none">
              <div class="d-flex justify-content-between align-items-center mb-2 flex-wrap gap-2">
                <div>
                  <div class="small text-muted text-uppercase">Cliente seleccionado</div>
                  <div class="fw-semibold" id="lblClienteSeleccionado"></div>
                  <div class="small text-muted">
                    Tickets: <span id="lblTotalTickets">0</span>
                  </div>
                </div>

                <!-- Toggle vista -->
                <div class="btn-group btn-group-sm" role="group" aria-label="Vista de tickets">
                  <button type="button"
              ...
              <!-- Contenedor donde se pintan Zonas/Sedes + tickets -->
              <div id="contenedorTickets">
                <!-- admin_tickets.js genera aquí la vista (tabla o cards) -->
              </div>
            </div>
          </div>
        </div>
