      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form id="formNuevoUsuario">
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="uAPaterno" required>
                </div>
                <div class="col-md-6">
                  <label class="form-label">Apellido materno</label>
                  <input type="text" class="form-control" id="uAMaterno">
                </div>
                <div class="col-md-6">
                  <label class="form-label">Correo</label>
                  <input type="email" class="form-control" id="uCorreo" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <label class="form-label">Nivel dentro del cliente</label>
                  <select class="form-select" id="uNivel" required>
                ...
                <!-- Si usas zona / sede, déjalos aquí (opcionales) -->

                <div class="col-md-6">
                  <label class="form-label">Zona</label>
                  <select class="form-select" id="uZona">
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select" id="uSede">
          ...
          <div class="modal-footer border-0">
            ...
            <button type="submit" form="formNuevoUsuario" class="btn btn-primary" id="btnCrearUsuario">
